...
class Guideline : AppCompatActivity() {
    ...
    private fun addDataToList() {
        ...
        glList.add(GuidelineModel("com.example.recycleviewwithclicklistener.mangroveDescription","Mangrove Plants Description", "Guide on using the Mangrove Plants Description screen",R.drawable.readme_desc,R.drawable.readme_desc2,R.drawable.readme_desc3,null))
        glList.add(GuidelineModel("com.example.recycleviewwithclicklistener.Identify","Identify", "Guide on using the Identify screen",R.drawable.readme_identify,R.drawable.readme_identify2,R.drawable.readme_identify3,R.drawable.readme_identify4))
        glList.add(GuidelineModel("com.example.recycleviewwithclicklistener.CollectionPage","MyCollection", "Guide on using the MyCollection screen", R.drawable.readme_collection,R.drawable.readme_collection2,null,null))
